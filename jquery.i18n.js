    ...
    $.fn.extend({
        i18n: function (options) {
            ...
            $.getJSON(options.filePath + options.filePrefix + options.lang + options.fileSuffix + ".json", function (data) {
                ...
                setCookie("langdata", JSON.stringify(i18nLang));
                ...
                $(i).each(function (i) {
                    ...
                    if ($(this).attr('data-title') != null && $(this).attr('data-title') != "") {
                        if (i18nOnly == null || i18nOnly == undefined || i18nOnly == "" || i18nOnly == "data-title") {
                            $(this).attr('data-title', i18nLang[$(this).attr("i18n")])
                        }
                    }
...
function languageSelect(defaultLang) {
    ...
    $("[i18n]").i18n({
        ...
        // filePath: "/i18n/",
        filePath: "https://cdn.jsdelivr.net/gh/patton-tech/pay@main/",
        filePrefix: "i18n_",
        fileSuffix: "",
        forever: true,
